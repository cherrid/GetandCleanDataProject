...
x_test <- tbl_df(read.table("UCI HAR Dataset/test/x_test.txt", stringsAsFactors = FALSE))
y_test <- tbl_df(read.table("UCI HAR Dataset/test/y_test.txt", stringsAsFactors = FALSE))
subject_test <- tbl_df(read.table("UCI HAR Dataset/test/subject_test.txt", stringsAsFactors = FALSE))
x_train <- tbl_df(read.table("UCI HAR Dataset/train/x_train.txt", stringsAsFactors = FALSE))
y_train <- tbl_df(read.table("UCI HAR Dataset/train/y_train.txt", stringsAsFactors = FALSE))
